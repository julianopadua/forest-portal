<!--
  TEMPLATE DE POST — não é servido pelo site; copie para content/blog/{slug}.md
  e registe o slug em src/lib/blog/catalog.ts (array BLOG_POST_SLUGS).
...
subtitle: "Uma linha opcional que aparece abaixo do título."
excerpt: "Resumo curto para cards e meta SEO (1–2 frases)."
...
![Legenda da figura no texto](/images/blog/SEU-SLUG/exemplo.png)
