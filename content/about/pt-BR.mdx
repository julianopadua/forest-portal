...
<AboutSection
  ...
  image3Alt="Prévia do TCC com capa e páginas internas"
  image3Caption="TCC - prévia visual (capa e páginas internas)"
  image3Fit="contain"
  imagePosition="right"
>
  ...
  <div className="not-prose -mt-2">
    ...
    >
      {"Ver trabalho de conclusão de curso"}
    </a>
  </div>

  Depois do TCC, condensei parte dessa linha de pesquisa em um preprint: um benchmark retrospectivo de covariáveis espaçotemporais para detecção diária de focos ativos em Unidades de Conservação do Cerrado (MG), com rótulos INPE BDQueimadas e avaliação em validação cruzada temporal e AOIs independentes.
  ...
  <div className="not-prose -mt-2">
    <a
      ...
      rel="noreferrer noopener"
    >
      {"Ver preprint no arXiv"}
    </a>
  </div>

  Você pode me conhecer melhor acessando meu [portfólio online](https://julianopadua.github.io/portfolio/).
</AboutSection>
...
<AboutSection title="Aviso sobre uso de inteligência artificial">
