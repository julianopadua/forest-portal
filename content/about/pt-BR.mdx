...
<AboutSection
  ...
  image3Caption="TCC - prévia visual"
  imagePosition="right"
>
  ...
  Depois do TCC, condensei parte dessa linha de pesquisa em um preprint: um benchmark retrospectivo de covariáveis espaçotemporais para detecção diária de focos ativos em Unidades de Conservação do Cerrado (MG).
