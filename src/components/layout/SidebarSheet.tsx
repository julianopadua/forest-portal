...
{/* Overlay com opacidade reduzida (bg-black/20) para menor escurecimento da interface subjacente */}
<div className="absolute inset-0 bg-black/20 backdrop-blur-sm" onClick={onClose} />
    <aside
      /* Largura responsiva: 320px para mobile e 400px para dispositivos desktop (md+) */
