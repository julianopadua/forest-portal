...
export default function BlogMarkdown({ content }: { content: string }) {
  return (
    <div className="prose prose-lg max-w-none min-w-0 text-[color:var(--foreground)] prose-headings:scroll-mt-24 prose-headings:font-semibold prose-headings:tracking-tight prose-headings:text-[color:var(--foreground)] prose-h2:mt-12 prose-h2:text-2xl prose-h3:mt-8 prose-p:leading-relaxed prose-p:text-left prose-p:hyphens-auto prose-p:text-[color:var(--muted)] md:prose-p:text-justify prose-li:text-left prose-li:leading-relaxed prose-li:hyphens-auto prose-li:text-[color:var(--muted)] md:prose-li:text-justify prose-blockquote:border-[color:var(--primary)]/40 prose-blockquote:text-[color:var(--muted)] prose-code:rounded-md prose-code:bg-[color:var(--surface-2)] prose-code:px-1 prose-code:py-0.5 prose-code:text-[0.9em] prose-code:text-[color:var(--foreground)] prose-pre:overflow-x-auto prose-pre:bg-[color:var(--surface-2)] prose-pre:border prose-pre:border-[color:var(--border)] prose-hr:border-[color:var(--border)] prose-strong:text-[color:var(--foreground)]">
      <ReactMarkdown
