...
function useScrollGreenBackdrop() {
  useEffect(() => {
  ...
  return (
    <section id={id} className="py-7 md:py-9 scroll-mt-24">
      <div className="mx-auto max-w-6xl px-4">
        <Reveal>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-9 backdrop-blur-xl">
    ...
    <div className="relative">
      ...
      <div className="relative z-10">
        ...
        <section className="py-10 md:py-12">
          <div className="mx-auto max-w-6xl px-4">
            <Reveal>
              <div className="rounded-3xl border border-white/10 bg-gradient-to-b from-white/10 to-white/5 p-8 md:p-11 backdrop-blur-xl">
        ...
        >
          <div className="grid gap-3 md:grid-cols-2">
            <InfoCard title="Propósito institucional">
              ...
              <p className="mt-3">
                O Instituto prioriza transparência metodológica: o dado final deve ser acompanhado do processo que o produz,
                incluindo coleta, validação e transformação.
              </p>
            </InfoCard>
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <InfoCard title="Mariceia Barbosa Silva Pádua">
              ...
              <p className="mt-3">
                ...
                menos visível e mais essencial da conservação: execução contínua, presença em campo e disciplina institucional.
              </p>
              <p className="mt-3">
            ...
            <InfoCard title="Maria Tereza Jorge Pádua">
              <p>
                Engenheira agrônoma, ambientalista e conservacionista reconhecida pela contribuição decisiva na criação e consolidação
                de áreas protegidas no Brasil, com atuação institucional e técnica em políticas de conservação.
              </p>
              <p className="mt-3">
                Sua trajetória se relaciona à estruturação de instrumentos e redes de conservação, articulando ciência, gestão pública e
                proteção territorial.
              </p>
              <p className="mt-3">
                Esta dedicatória sustenta que acesso aberto ao conhecimento, à evidência e ao método é parte do mesmo projeto público
                que sustenta a conservação: ampliar capacidades e proteger a vida em escala.
              </p>
            </InfoCard>
          </div>

          <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-5 text-sm text-zinc-300">
